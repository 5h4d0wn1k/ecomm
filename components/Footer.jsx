    ...
    const linkSections = [
        ...
        },
        {
            ...
            links: [
                ...
                { text: "Cancellation and Refund Policy", path: '/cancellation-refund', icon: null },
                { text: "Shipping & Delivery Policy", path: '/shipping-delivery', icon: null },
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "+91-XXXXXXXXXX", path: '/', icon: PhoneIcon },
                { text: "support@davcreations.in", path: '/', icon: MailIcon },
                { text: "Aravali Heights, B3 – 64 Dawarkadhish, Sector 24, Dharuhera, Rewari, Haryana 123106", path: '/', icon: MapPinIcon },
                { text: "Monday to Friday, 10:00 AM – 7:00 PM (IST)", path: '/', icon: null }
            ]
        }
    ];
        ...
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-700">
                            <span className="text-red-600">Dav</span>Creations<span className="text-red-600 text-5xl leading-0">.</span>
                        </Link>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © DavCreations All Right Reserved.
                </p>
            </div>
        </footer>
    );
