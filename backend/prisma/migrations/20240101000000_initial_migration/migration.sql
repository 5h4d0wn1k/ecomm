...
-- CreateEnum
CREATE TYPE "ApplicableTo" AS ENUM ('all', 'specific_vendors', 'specific_categories', 'specific_products');

-- CreateEnum
CREATE TYPE "ShippingConditionType" AS ENUM ('weight', 'price', 'quantity');

-- CreateEnum
CREATE TYPE "EarningStatus" AS ENUM ('pending', 'available', 'paid', 'on_hold');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('order', 'payment', 'shipping', 'vendor', 'system');
...
CREATE TABLE "vendors" (
    ...
    "totalSales" DECIMAL(65,30) NOT NULL DEFAULT 0.00,
